...
from BiFlowNet.channelnorm_package.modules.channelnorm import ChannelNorm
from BiFlowNet import FlowNetC
from BiFlowNet  import FlowNetS
from BiFlowNet  import FlowNetSD
from BiFlowNet  import FlowNetFusion
...
class FlowNet2(nn.Module):
    ...
    def __init__(self, args, batchNorm=False, div_flow = 20., requires_grad=False):
        ...
        self.upsample1 = nn.Upsample(scale_factor=4, mode='bilinear')#bilinear
